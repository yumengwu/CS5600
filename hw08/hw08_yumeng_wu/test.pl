...
my $hw7_l = run_prog("collatz-list-xv6", 100);
ok($hw7_l =~ /at 97: 118 steps/, "list-xv6 100");

my $hw7_v = run_prog("collatz-ivec-xv6", 100);
ok($hw7_v =~ /at 97: 118 steps/, "ivec-xv6 100");
